...
<head>
    ...
    <style>
        ...
        .filter {
            ...
            border-radius: 10px;
            margin-left: 40px; /* Adjusted margin to create a left gap */
            position: sticky; /* Keep filter box sticky while scrolling */
        ...
        .filter input {
            width: calc(50% - 10px); /* Adjusted width to 50% minus margin for spacing */
            padding: 10px;
            margin-right: 10px; /* Added margin between inputs */
            margin-bottom: 10px;
        ...
        <div class="container">
            <div class="catering" id="Catering">
                ...
                <div class="catering-box">
                    ...
                    $sql = "SELECT * FROM product_list WHERE category='Makeup Artist'";
